...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center
      ...
      .col-12.col-md-12.col-lg-8.d-flex.align-items-center.bg_grad-13(data-aos="fade-left")  
        div
    ...
    .row.mb-5.justify-content-center
      .col-12.col-md-12.col-lg-7.order-2.order-lg-1mb-3.d-flex.align-items-center.bg_grad-01(data-aos="fade-right")
        div
    ...
    AcordionA.bgr_9_1(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
      ...
      .row(titulo="Cumpla sus promesas").p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
      ...
      .row(titulo="Simplicidad").p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
      ...
      .row(titulo="Busque una solución").p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
    ...
    .row.justify-content-center
      .col-md-6.col-lg-5(data-aos="fade-up-right")
      ...
      .col-md-6.col-lg-5(data-aos="fade-down-left")
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
