...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.justify-content-center
      ...
      .col-12.col-md-6.col-lg-4.order-1.order-lg-2(data-aos="fade-left")
        figure
    ...
    AcordionA.mb-5.bgr_9(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")(data-aos="fade-up-right")
      .row(titulo="Solicitudes informativas").p-4.justify-content-center
      ...
      .row(titulo="PQR").p-4.p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
      ...
      .row(titulo="PQR: petición").p-4.p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
      ...
      .row(titulo="PQR: queja").p-4.p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
      ...
      .row(titulo="PQR: reclamo").p-4.p-4.justify-content-center
        .col-md-12.col-lg-8.mb-4.mb-md-0.align-items-center.p-4
